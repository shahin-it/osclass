...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_ec_product (
  ...
  b_is_new BOOLEAN DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS /*TABLE_PREFIX*/t_ec_widget (
  pk_w_id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,

  s_name VARCHAR(100) NOT NULL ,
  s_widget_id VARCHAR(100) NOT NULL ,
  s_widget_content_type VARCHAR(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARACTER SET 'UTF8' COLLATE 'UTF8_GENERAL_CI';